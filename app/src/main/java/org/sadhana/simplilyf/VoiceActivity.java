...
/**
 * Created by sophiango on 11/23/15.
 */
public class VoiceActivity extends Activity implements View.OnClickListener, TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {
...
//                            }
    ...
    public class PhilipsColorChange extends AsyncTask<String, Void, PhilipsData> {
        ...
        protected PhilipsData doInBackground(String... params) {
            ...
            InputStream inputStream = null;
            //int deviceNum=params[0];
            String endpoint= SERVER+"/light/color/"+params[0]+"/"+params[1];
            HttpURLConnection urlConnection = null;
            Integer result = 0;
            PhilipsData msg=new PhilipsData();
            try {
    ...
    public class PhilipsColorChangeAllRoom extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            InputStream inputStream = null;
            //int deviceNum=params[0];
            String endpoint= SERVER+"/light/all/color/"+params[0];
            HttpURLConnection urlConnection = null;
            Integer result = 0;
            PhilipsData msg=new PhilipsData();
            try {
