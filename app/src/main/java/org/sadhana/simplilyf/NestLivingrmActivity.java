...
public class NestLivingrmActivity extends ActionBarActivity {
   ...
   final String SERVER = "http://10.189.115.48:3000";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("res receuved" + res_temp);
        mTempValue.setText(res_temp.toString());
        mAwayBtn=(Button)findViewById(R.id.awayBtn);
        mCoolBtn=(Button)findViewById(R.id.coolBtn);

        mUpdate=(Button)findViewById(R.id.updateTempBtn);
        mUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new UpdateTempAsync().execute(devicename,mUpdateTempValue.getText().toString());
   ...
   public class UpdateTempAsync extends AsyncTask<String,Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            mTempValue.setText(mUpdateTempValue.getText().toString());
            mUpdateTempValue.setText(null);
        }
    }
